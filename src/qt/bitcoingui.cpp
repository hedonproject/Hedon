...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hedon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hedon: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Hedon"), this);
    aboutAction->setStatusTip(tr("Show information about Hedon"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hedon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hedon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/question"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hedon addresses"));
    ...
    openAction->setStatusTip(tr("Open a hedon: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/debug"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hedon help message to get a list with possible Hedon command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Hedon client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hedon network", "", count));
}
...
{
    QString strTitle = tr("Hedon"); // default title
