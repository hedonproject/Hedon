    ...
    mapper(0)
{
    ...
    //ui->theme->addItem(QString("HDN-light"), QVariant("light"));
    //ui->theme->addItem(QString("HDN-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("HDN-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("HDN-traditional"), QVariant("trad"));
