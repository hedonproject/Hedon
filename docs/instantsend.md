...
This mechanism has been integrated into Bitcore-Node-Hedon which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hedoncoin/insight-api-hedon#web-socket-api](https://github.com/hedoncoin/insight-api-hedon#web-socket-api) 
* API: [https://github.com/hedoncoin/insight-api-hedon#instantsend-transactions](https://github.com/hedoncoin/insight-api-hedon#instantsend-transactions) 
...
By default, the Hedon daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Hedon daemon:
