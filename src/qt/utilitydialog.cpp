    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Hedon") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  hedon-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Hedon in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an hedontive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 HDN, 0.1 HDN, 1 HDN and 10 HDN -- sort of like the paper money you use every day.</li> \
...
Consequently, users who have backups disabled will also have PrivateSend disabled. <hr>\
    ...
    ui->aboutLogo->setContentsMargins(17,110,0,0);
}
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Hedon is shutting down...") + "<br /><br />" +
