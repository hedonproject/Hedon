...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HedonNetwork") type = HedonNetwork;
    if(strType == "HedonNetworkVariable") type = HedonNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HedonNetwork) s = "HedonNetwork";
    if(type == HedonNetworkVariable) s = "HedonNetworkVariable";
