...
Only requiring some minor changes is hedon.cpp.
...
Changes to hedon.cpp
----------------------
hedon.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
