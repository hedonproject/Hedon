 ...
 *
 *   // network
 *   CHedonNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.hedoncoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CHedonNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: HedonNetwork
// //   -- signature requirements : Key1(User)
// class CHedonNetworkVariable : public CGovernanceObject
// {
// private:
