/* src/config/hedon-config.h.  Generated from hedon-config.h.in by configure.  */
/* src/config/hedon-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Hedon developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Hedon"
...
#define PACKAGE_BUGREPORT "https://github.com/hedoncoin/hedoncoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hedon"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hedon 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hedoncore"
