    ...
    walletModel(0)
{
    ...
    ui->tableWidgetMasternodes->setStyleSheet("QTableView { background-color: transparent;  border: 0px solid #fff; }");

    ui->tableWidgetMyMasternodes->setShowGrid(false);
    ui->tableWidgetMyMasternodes->setAlternatingRowColors(false);
    ui->tableWidgetMyMasternodes->setStyleSheet("QTableView { background-color: transparent; border: 0px solid #fff; }");
